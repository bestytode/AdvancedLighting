...
int main()
{
    ...
    Shader shader("res/shaders/blinn_phong.vs", "res/shaders/blinn_phong.fs");
    shader.Bind();
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        // floor
        glBindVertexArray(planeVAO);
        glActiveTexture(GL_TEXTURE0); // Optional since we have only one texture here
